...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.customer_label = tk.Label(
            self.master, text='Roll no.', font=('bold', 14))
        ...
        self.retailer_label = tk.Label(
            self.master, text='Department', font=('bold', 14))
        ...
        self.price_label = tk.Label(
            self.master, text='Section', font=('bold', 14))
        ...
        self.add_btn = tk.Button(
            self.master, text="Add data", width=12, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Remove data", width=12, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update data", width=12, command=self.update_item)
